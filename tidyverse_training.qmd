...
Conçu pour manipuler les chaines de caractères "facilement". <br>En plus d'être plus faciles à utiliser, le nom des fonctions dans [stringr](https://stringr.tidyverse.org/){.external target="_blank"} représentent bien ce qu'elles permettent de faire.

![](images/logo_stringr.png){.absolute top="40" right="20" width="15%"}

. . .

Le nom de toutes les fonctions dans [stringr](https://stringr.tidyverse.org/){.external target="_blank"} commence par `str_`.
...
<center>Lien vers le [cheatsheet](https://github.com/rstudio/cheatsheets/blob/main/strings.pdf){.external target="_blank"} du package [stringr](https://stringr.tidyverse.org/){.external target="_blank"}.</center>
