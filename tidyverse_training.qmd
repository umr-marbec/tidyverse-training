...
::: {style="float: right;"}
[Cheatsheet stringr](https://github.com/rstudio/cheatsheets/blob/main/strings.pdf){.external target="_blank"}
:::

<br>

::: {style="float: right;"}
[Cheatsheet lubridate](https://github.com/rstudio/cheatsheets/blob/main/lubridate.pdf){.external target="_blank"}
:::
