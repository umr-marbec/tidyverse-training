...
3.  Mise en application
    ...
    # fish_data <- read_csv("data/Global_reef_fish_abundance_and_biomass.csv") %>% filter(survey_id == 2000951)
    ```

    ```{r echo=TRUE, warnings=FALSE}
    # p1 <- ggplot(data    = fish_data,
...
-   `geom_line()` pour une ligne
-   `geom_boxplot()` pour une boîte à moustache
-   `geom_col()` pour un diagramme en barres
...
# plot + scale_fill_manual(values = c("pink", "green", "red", "blue", "yellow"))
