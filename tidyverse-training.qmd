...
::: incremental - A partir du dernier popEU_long généré, transformer la colonne pop en caractères et créer deux nouvelles "millions" et "milliers"
...
On utilise la fonction `str_replace()` et ses arguments principaux :
...
On utilise la fonction `str_glue()` et ses deux principaux arguments :
