...
## ***readr*** permet de lire depuis plusieurs fichiers et mêmes répertoires
...
## On peut faire un filtre en entrée sur les valeurs d'une colonne avec `read_..._chunked` {.smaller}
