...
En utilisant les fonctions vues précédemment 
  - Quel est le pays où la biomasse totale par transect est la plus élevée ?
  - Formattez le jeu de données issues de l'**exercice 5.1** et représentez visuellement les données sous forme de boites à moustache, **seulement pour les données prélevées en 2011**. Nommer le jeu de données **data_biomass_country**.
