...
<br/>
<br/>
![](images/vectorized_function.png){.absolute top="300" left="250" width="50%"}
...
## Exercice 2 {auto-animate="true" .smaller}
...
## Exercice 2 corrigé {auto-animate="true" .smaller}
...
- Fonctions qui vont créer une nouvelle table avec des resumés statistique. De manière globale, les fonctions associées vont utiliser en entrée des vecteurs et en sortie une ou plusieurs valeurs (inférieur en nombre au nombre de vecteurs d'entrée)
<br/>
<br/>
<br/>
![](images/summary_function.png){.absolute top="200" left="250" width="50%"}
...
## Exercice 3 {auto-animate="true" .smaller}
...
## Exercice 3 corrigé {auto-animate="true" .smaller}
...
`pivot_wider()`et `pivot_longer()`sont les successeurs des fonctions en base R du package `reshape` puis `reshape2`. Et se nommaient `spread()`et `gather()` dans les premières versions de `tidyr` - Transformer un tableau long en format large
