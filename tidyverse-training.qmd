...
[Monique Simier (monique.simier\@ird.fr)]{style="color:#ffffff; font-size: 1em"} <br/> [Laure Velez (laure.velez\@umontpellier.fr)]{style="color:#ffffff; font-size: 1em"} <br/> [Gael Mariani (jean.jacques.mariani\@umontpellier.fr)]{style="color:#ffffff; font-size: 1em"} <br/> [Mathieu Depetris (mathieu.depetris\@ird.fr)]{style="color:#ffffff; font-size: 1em"} <br/> <br/> [05-06 decembre 2022]{style="color:#ffffff; font-size: 1em"} <br/> <br/> <br/> [© RStudio]{style="color:#ffffff; font-size: 0.4em"}
...
## Exercice 1 corrigé {auto-animate="true"}
...
```{r echo=TRUE, eval=FALSE}
# solution
tmp1 <- distinct(.data = global_reef_fish_biomass)
...
```{r echo=TRUE, eval=FALSE}
tmp1 <- filter(.data = distinct(.data = global_reef_fish_biomass),
               biomass != 0
               & ! family %in% c("Mullidae",
                                 "Kyphosidae")
               & size_class <= 10)
...
## Exercice 2 {.smaller auto-animate="true"}
...
-   Supprimer la première colonne du jeu de données (utiliser son indice) ainsi que la colonne survey_id
...
-   Supprimer les variables size_class et size_class_cm
...
## Exercice 2 corrigé {.smaller auto-animate="true"}
...
## Exercice 3 {.smaller auto-animate="true"}

-   À partir du jeu de données de sortie de l'exercice 2
-   Calculer la biomasse moyenne par espèce et classe de taille
...
## Exercice 3 corrigé {.smaller auto-animate="true"}
...
```{r echo=TRUE, eval=FALSE}
# solution
# group_by sur espece et class de taille, faire la somme à ce moment la
tmp4 <- tmp3 %>%
  dplyr::group_by(species_name,
                  size_class_mm) %>%
  summarise(mean_biomass = mean(x = biomass),
            .groups = "drop")

tmp5 <- dplyr::group_by(.data = tmp3,
                        family) %>%
...
## Exercice 4 {.smaller auto-animate="true"}
...
## Exercice 4 corrigé {.smaller auto-animate="true"}
...
```{r echo=TRUE, eval=FALSE}
# solution
global_reef_fish_biomass_light <- slice_sample(.data = global_reef_fish_biomass,
                                               prop = 0.5)
tmp6 <- inner_join(x = global_reef_fish_biomass_light,
                   y = global_reef_fish_abundance,
                   by = "survey_id")
```
...
## Exercice 1 {.smaller auto-animate="true"}
...
## Exercice 1 corrigé {.smaller auto-animate="true"}
...
## Exercice 5 {.smaller auto-animate="true"}
...
## Exercice 5 corrigé {.smaller auto-animate="true"}
...
## Exercice 6 {.smaller auto-animate="true"}
...
## Exercice 6 corrigé {.smaller auto-animate="true"}

-   Corrigez l'erreur

```{r echo=TRUE, eval=FALSE}
# solution
data_sf <- biomass_abundance %>%
  drop_na(latitude) %>%
  drop_na(longitude) %>%
